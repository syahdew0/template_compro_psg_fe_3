<template>
  <div class="w-screen min-h-screen flex flex-col overflow-auto">
    <Navbar />
    <div class="overflow-x-auto snap-x snap-mandatory h-screen w-screen">
      <HorizontalSlides />
    </div>
...
import VerticalSections from './components/VerticalSections.vue';
import FooterPage from './components/FooterPage.vue'; // Pastikan ini digunakan
</script>
